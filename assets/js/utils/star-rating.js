...
function starIcon(state) {
    return `<svg class="star-icon star-icon--${state}" viewBox="0 0 24 24" aria-hidden="true"><path class="star-icon__outline" d="${OUTLINE_PATH}"/><path class="star-icon__fill" d="${SOLID_PATH}"/></svg>`;
}
