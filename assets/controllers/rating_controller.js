...
/**
 * Rating Controller
 * Renders interactive star rating widget with half-star support
 */
export default class extends BaseController {
    ...
    setupEvents() {
        ...
        this.starTargets.forEach(function (star) {
            star.addEventListener('click', function (e) {
                e.preventDefault();
                const value = self.getValueFromClick(star, e);
                self.setRating(value);
            });
        });

        this.wrapper.addEventListener('mouseleave', function () {
            self.updateDisplay(self.currentValueValue || 0);
        });

        this.starTargets.forEach(function (star) {
            star.addEventListener('mousemove', function (e) {
                const value = self.getValueFromHover(star, e);
    ...
    updateDisplay(value) {
        const self = this;
        this.starTargets.forEach(function (star, index) {
            ...
            star.innerHTML = self.getStarSVG(type);
        });
    }
