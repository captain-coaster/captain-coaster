...
export default class extends BaseController {
    ...
    static values = {
        ...
        labelUpvote: { type: String, default: 'Upvote' },
        labelRemoveUpvote: { type: String, default: 'Remove upvote' },
        labelSubmitReport: { type: String, default: 'Submit' },
        labelReportSuccess: { type: String, default: 'Report submitted.' },
        labelReportError: { type: String, default: 'An error occurred.' },
    };
    ...
    upvote(event) {
        ...
        this.send('POST', this.upvoteUrlValue)
            .then((data) => {
                if (data.success) {
    ...
    submitReport(event) {
        ...
        if (submitButton) {
            ...
            submitButton.textContent = this.labelSubmitReportValue;
        }
        ...
        fetch(this.reportUrlValue, {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    this.showSuccess(this.labelReportSuccessValue);
                } else {
                    if (submitButton) {
                        submitButton.disabled = false;
                    }
                    this.showError(data.message || this.labelReportErrorValue);
                }
            })
            .catch(() => {
                if (submitButton) {
                ...
                this.showError(this.labelReportErrorValue);
            });
    }
