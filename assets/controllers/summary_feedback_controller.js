...
export default class extends BaseController {
    ...
    /**
     * Override base getCsrfToken to use the injected token value
     * (AJAX-loaded content has no csrf-protection outlet or meta tag)
     */
    getCsrfToken() {
