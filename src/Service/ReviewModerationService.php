...
class ReviewModerationService
{
    ...
    private function buildPrompt(RiddenCoaster $review): string
    {
        ...
        $prompt .= "   - \"ok\": on-topic ride opinion about the experience, mechanics, or sensations of riding the coaster. Profanity is acceptable if combined with substantive, genuine opinions about the ride or park experience (e.g. \"the theming is crap but the airtime is amazing\" or \"this ride fucking sucks, way too rough and the restraints dig into your shoulders\" or \"cette attraction est de la merde en barre mais l'ambiance est sympa\"). Also ok: positive park experience comments (staff friendliness, customer service). Also ok: physical reactions to the ride itself (headache, nausea, discomfort) even if negative. Flag as toxic if the review is pure hostility with no substantive opinion (e.g., \"this ride fucking sucks ass, worst experience of my life\").\n";
        $prompt .= "   - \"toxic\": hostile, insulting, or aggressive content, especially if directed at people (reviewers, staff, management) or if it attacks people while describing the ride. Examples: \"yall glazers are just living in an echo chamber\" (attacks reviewers), \"idiots running the queue\" (attacks staff), \"fuck this stupid park and everyone who works here\" (attacks people). A review that insults people rather than just the ride, even if it also contains some ride description, should be toxic.\n";
